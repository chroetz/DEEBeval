...
for (tnr in unique(data$taskNr)) {
  ...
  for (lss in unique(taskData$loss)) {
    ...
    for (onr in unique(lssData$obsNr)) {
      ...
      cat(showStatsTable(
        meanScoreData,
        paste0("Task ", tnr, ", obsNr ", onr, ": ", lss, " - Trimmed Score Statistics")))
      
      cat("\n\n")
      cat(showStatsTable(
        rankScoreData,
        paste0("Task ", tnr, ", obsNr ", onr, ": ", lss, " - Rank Score Statistics")))
...
for (tnr in unique(data$taskNr)) {
  ...
  for (lss in unique(taskData$loss)) {
    ...
    for (onr in unique(lssData$obsNr)) {
      ...
      cat(showStatsTable(
        obsData,
        paste0("Task ", tnr, ", obsNr ", onr, ": ", lss, " - Score Statistics"),
